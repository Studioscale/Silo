...
> **Status (2026-06):** v0.2.2 (implementing the v12.5 spec) in production on a single-user Hetzner VPS managing ~25 knowledge domains. 520 unit tests passing. Spec finalized after 57 audit rounds across 19 drafts (three independent reviewers per round — Claude, ChatGPT, Gemini). Implementation in [`src/`](src/), described in [IMPLEMENTATION.md](IMPLEMENTATION.md).
